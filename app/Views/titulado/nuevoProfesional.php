    ...
    <div class="content">
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="formulario-nuevo" method="POST" action="<?php echo base_url(); ?>/CTitulado/insertarProfesional" autocomplete="off">
                        <input type="hidden" name="id_prof" id="id_prof" value="<?php echo $id_prof; ?>">
                        <p>
                            <font style="color: red; font-weight: bold;">NOTA: </font><strong>Verifique que todos los datos sean correctos ya que no podrán ser editados despues de su registro, estos serán verificados por Kardex Académico. Si los datos no son correctos se procederá al bloqueo de la cuenta.</strong>
                        </p>
                        <?php csrf_field(); ?>
