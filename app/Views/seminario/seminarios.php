        ...
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-body">
                    <div>
                        <p>
                            <a href="<?php echo base_url(); ?>/CSeminario/nuevo" class="btn btn-success"><i class='fas fa-user-plus'></i> Agregar</a>
                            <a href="<?php echo base_url(); ?>/CSeminario/eliminados" class="btn btn-secondary"><i class='fas fa-user-alt-slash'></i> Archivados</a>
                        </p>
                    </div>
