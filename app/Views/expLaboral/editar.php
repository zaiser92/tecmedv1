    ...
    <div class="content">
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="formulario-nuevo" method="POST" action="<?php echo base_url(); ?>/CExpLaboral/actualizar" autocomplete="off">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="empresa_institucion" id="empresa_institucion" value="<?php echo $datos['empresa_institucion']; ?>">
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="cargo" id="cargo" value="<?php echo $datos['cargo']; ?>">
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <textarea class="form-control" name="actividades" id="actividades" cols="30" rows="6"><?php echo $datos['actividades']; ?></textarea>
                                        </div>
                                    </div>
                                </div>
