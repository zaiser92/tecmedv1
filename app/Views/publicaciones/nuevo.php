    ...
    <div class="content">
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="formulario-nuevo" method="POST" action="<?php echo base_url(); ?>/CPublicaciones/insertar" autocomplete="off">
                        <?php csrf_field(); ?>
                                ...
                                <div class="col-sm-6 d-flex align-items-center justify-content-center">
                                    <div class="form-group">
                                        ...
                                        <div class="custom-control custom-radio">
                                            <input class="custom-control-input custom-control-input-primary" type="radio" id="libro" name="tipo" value="libro" <?php echo set_radio('tipo', 'libro'); ?>>
                                            <label for="libro" class="custom-control-label">Libro</label>
                                        </div>
                                        <div class="custom-control custom-radio">
                                            <input class="custom-control-input custom-control-input-primary" type="radio" id="articulo cientifico" name="tipo" value="Artículo Científico" <?php echo set_radio('tipo', 'Artículo Científico'); ?>>
                                            <label for="articulo cientifico" class="custom-control-label">Artículo Científico</label>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-6 d-flex align-items-center justify-content-center">
                                    <div class="form-group">
                                        ...
                                        <div class="custom-control custom-checkbox">
                                            <input class="custom-control-input" type="checkbox" id="autor" name="colaboracion[]" value="autor" <?php echo set_checkbox('colaboracion[]', 'autor'); ?>>
                                            <label class="custom-control-label" for="autor">Autor</label>
                                        </div>
                                        <div class="custom-control custom-checkbox">
                                            <input class="custom-control-input" type="checkbox" id="coautor" name="colaboracion[]" value="coautor" <?php echo set_checkbox('colaboracion[]', 'coautor'); ?>>
                                            <label class="custom-control-label" for="coautor">Coautor</label>
                                        </div>
                                        <div class="custom-control custom-checkbox">
                                            <input class="custom-control-input" type="checkbox" id="editor" name="colaboracion[]" value="editor" <?php echo set_checkbox('colaboracion[]', 'editor'); ?>>
                                            <label class="custom-control-label" for="editor">Editor</label>
                                        </div>
                                        <div class="custom-control custom-checkbox">
                                            <input class="custom-control-input" type="checkbox" id="revisor" name="colaboracion[]" value="revisor" <?php echo set_checkbox('colaboracion[]', 'revisor'); ?>>
                                            <label class="custom-control-label" for="revisor">Revisor</label>
                                        </div>
                                        <div class="custom-control custom-checkbox">
                                            <input class="custom-control-input" type="checkbox" id="colaborador en la investigacion" name="colaboracion[]" value="colaborador en la investigación" <?php echo set_checkbox('colaboracion[]', 'colaborador en la investigación'); ?>>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" name="anio_publicacion" id="anio_publicacion" value="<?php echo set_value('anio_publicacion') ?>">
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="nombre_revista" id="nombre_revista" value="<?php echo set_value('nombre_revista') ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
