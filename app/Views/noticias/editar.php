    ...
    <div class="content">
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-body">
                    <form enctype="multipart/form-data" class="formulario-nuevo" method="POST" action="<?php echo base_url(); ?>/CNoticias/actualizar" autocomplete="off">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="referencia" id="referencia" value="<?php echo $datos['referencia']; ?>">
                                        </div>
                                    </div>
