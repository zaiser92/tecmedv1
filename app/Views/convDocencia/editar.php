    ...
    <div class="content">
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-body">
                    <form enctype="multipart/form-data" class="formulario-nuevo" method="POST" action="<?php echo base_url(); ?>/CConvDocencia/actualizar" autocomplete="off">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="codigo" id="codigo" value="<?php echo $datos['codigo']; ?>" disabled>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="materia" id="materia" value="<?php echo $datos['materia']; ?>">
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" name="carga_horaria" id="carga_horaria" value="<?php echo $datos['carga_horaria']; ?>">
                                        </div>
                                    </div>
                                    <?php if (isset($validation) && $validation->getError('carga_horaria')) : ?>
                                        <div class="alert alert-danger" role="alert">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Fecha límite entrega documentos</label>
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i class="fas fa-calendar-alt"></i></span>
                                            </div>
                                            <input type="date" class="form-control" name="fecha_entrega_doc" id="fecha_entrega_doc" value="<?php echo $datos['fecha_entrega_doc']; ?>">
                                        </div>
                                    </div>
                                    <?php if (isset($validation) && $validation->getError('fecha_entrega_doc')) : ?>
                                        <div class="alert alert-danger" role="alert">
                                            <?= $validation->getError('fecha_entrega_doc') ?>
                                        </div>
                                    <?php endif; ?>
                                </div>
                                <div class="col-sm-6">
                            ...
                            <a href="<?php echo base_url(); ?>/CConvDocencia" class="btn btn-danger">Cancelar</a>
